...
<template>
    <nav class="fixed top-0 right-0 left-0 h-16 bg-[#e8eaef] border-b-[3px] border-[#0a0a0a] z-40 flex items-center px-6"
        ...
        <div class="flex-1 flex ">
            <div class="relative flex items-center bg-white rounded-xl border-2 border-[#0a0a0a] px-4 py-2.5">
                ...
                <input v-model="searchQuery" type="text" placeholder="Find something cool to watch..."
        ...
        <div class="rounded-4xl border-3 border-[#0a0a0a] px-2 py-1 bg-white ml-4 flex items-center gap-2">
            <NAvatar round bordered src="https://github.com/shadcn.png" size="large" style="border-color: black; border-width: 3px;" />
            <div style="font-family: 'Rounded', sans-serif; font-size: 16px; font-weight: bold;">Hello xxx!</div>
        </div>
